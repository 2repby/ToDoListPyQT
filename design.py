...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.deleteTaskButton.setGeometry(QtCore.QRect(384, 250, 171, 23))
        icon1 = QtGui.QIcon()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.markTaskAsDoneButton.setText(_translate("MainWindow", "Отметить как выполненные"))
        self.deleteTaskButton.setText(_translate("MainWindow", "Удалить выделенные"))
        self.markTaskAsNotDoneButton.setText(_translate("MainWindow", "Отметить как НЕ  выполненные"))
