...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("checked.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.markTaskAsDoneButton.setIcon(icon)
        ...
        self.markTaskAsNotDoneButton.setIcon(icon2)
        ...
        self.saveTaskButton.setIcon(icon3)
